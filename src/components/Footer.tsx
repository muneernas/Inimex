...
const Footer: React.FC = () => {
  return (
      <footer className="bg-gray-50 text-[#0f145b] w-full">
        {/* Top Section */}
        <div className="w-full px-6 py-10 flex flex-col md:flex-row gap-10">
          {/* Left Half - Contact Info */}
          <div className="md:w-1/2 space-y-2 text-gray-700 flex flex-col" id="contact-info">
          ...
          {/* Right Half - Map */}
          <div className="md:w-1/2 flex items-stretch flex flex-col">
